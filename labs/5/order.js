...
function update_order_list(){
    ...
    const dessertsSection = document.getElementById('desserts-selection');
    const salads_startersSection = document.getElementById('salads_starters-selection');
    ...
    if(orderList.desserts){
        dessertsSection.innerHTML = `${orderList.desserts.name} - ${orderList.desserts.price} ₽`;
    }
    if(orderList.salads_starters){
        salads_startersSection.innerHTML = `${orderList.salads_starters.name} - ${orderList.salads_starters.price} ₽`;
    }
